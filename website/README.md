...
> This is the website implementation, one part of the CASA 1569 business
> repository. It's self-contained (own dependencies, own config) — run
> all commands from inside this folder, not the repo root. Built against
> [`MASTER_BUILD_PROMPT.md`](./MASTER_BUILD_PROMPT.md) and the brand
> guides at [`/brand`](../brand); see [`/AGENTS.md`](../AGENTS.md) and
> [`/decisions`](../decisions) at the repo root for the wider business
...
From the repo root: `cd website` first. All commands below assume
